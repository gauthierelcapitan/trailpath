...
import { ElevationIgnResponseInterface } from '@trailpath/api/app/elevation/common/elevation-ign-response.interface';
import { IGN_ELEVATION_BATCH_SIZE } from '@trailpath/api/app/elevation/replace-elevation-ign/replace-elevation-ign.constant';
...
export class ReplaceElevationIgnService {
  ...
  private async fetchIgnElevation(
    ...
    const {
      ...
      this.httpService
        .get<ElevationIgnResponseInterface>(url, {
          timeout: 10000,
        })
        .pipe(

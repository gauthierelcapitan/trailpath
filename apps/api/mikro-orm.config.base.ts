...
export function mikroOrmConfigBase(
  path = __dirname,
): Partial<MikroORMOptions<PostgreSqlDriver>> {
  ...
  return {
    ...
    migrations: {
      ...
      path: path + '/src/app/data-access/migrations', // path to the folder with migrations
      pathTs: path + '/src/app/data-access/migrations', // path to the folder with TS migrations (if used, we should put path to compiled files in `path`)
